        ...
        <form action="" method='post' onSubmit={onSubmit}>
            <div className="shadow sm:overflow-hidden sm:rounded-md">
                <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                     ...
                     <div>
                        ...
                        <div className="mt-1 flex items-center">
                          ...
                          {!survey.image_url && (
                            ...
                            w-12 overflow-hidden rounded-full bg-gray-100'>
                          ...
                          py-2 px-2 text-sm font-medium leading-3 text-gray-700 shadow-sm hover:bg-gray-50
                     ...
                     <div className='col-span-6 sm-span-3'>
                        <label 
                          htmlFor="title"
